 ...
 *  USA
 *
 *  $Id: bantool.c 26308 2008-12-16 15:55:10Z androsyn $
 *
 *
...
main(int argc, char *argv[])
{
	...
	fprintf(stdout,
		"* ircd-ratbox bantool v.%s ($Id: bantool.c 26308 2008-12-16 15:55:10Z androsyn $)\n",
		BT_VERSION);
...
print_help(int i_exit)
{
	...
	fprintf(stderr, "$Id: bantool.c 26308 2008-12-16 15:55:10Z androsyn $\n\n");
